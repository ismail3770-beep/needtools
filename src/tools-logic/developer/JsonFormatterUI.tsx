    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-2 flex-wrap p-3 rounded-2xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={handleCopy}
            className="py-1.5 px-3.5 rounded-xl bg-black dark:bg-white hover:bg-black/90 dark:hover:bg-white/90 text-white dark:text-black font-bold text-xs flex items-center gap-1.5 shadow-sm transition-all"
          >
            {copied ? (
              <>
