        ...
        >
          <div className="px-6 py-16 sm:py-20 flex flex-col items-center justify-center text-center z-10 relative">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-black dark:text-white mb-3">
              Upload PDF to Unlock
            </h3>
            <p className="text-sm text-black/50 dark:text-white/50 max-w-md mx-auto mb-8">
              Drag & drop your encrypted PDF file here, or click to browse. Max size: 50MB.
            </p>
            ...
            <button
              ...
              className="px-8 py-3.5 bg-black dark:bg-white hover:bg-black/90 dark:hover:bg-white/90 text-white dark:text-black font-semibold rounded-xl shadow-sm hover:shadow transition-all flex items-center gap-2"
            >
              Choose PDF File
            </button>
            <p className="mt-4 text-xs font-medium text-black/40 dark:text-white/40 flex items-center justify-center gap-1.5">
              <ShieldOff className="w-3.5 h-3.5" />
              Remove passwords instantly
            </p>
          </div>
        </div>
      ) : (
