    ...
    <div className="space-y-6">
      ...
      {!resultBlob && (
        <>
          ...
          {/* File List */}
          {files.length > 0 && (
            <div className="bg-black/5 dark:bg-white/5/30 rounded-2xl p-6 border border-black/10 dark:border-white/10/50 space-y-4">
              <div className="flex justify-between items-center mb-2">
                <h4 className="font-semibold text-black/70 dark:text-white/70 dark:text-slate-300">
              ...
              <div className="space-y-2">
                {files.map((fileObj, index) => (
                  <div key={fileObj.id} className="flex items-center justify-between p-3 bg-white border border-black/10 dark:border-white/10 rounded-xl group">
                    <div className="flex items-center gap-3 overflow-hidden">
                      <div className="cursor-grab text-black/40 dark:text-white/40 hover:text-black/60 dark:text-white/60 flex flex-col gap-1">
                    ...
                    <button
                      ...
                      className="p-2 text-black/40 dark:text-white/40 hover:text-red-500 rounded-lg transition-colors shrink-0"
                    >
