    ...
    <div className="min-h-[calc(100vh-64px)] bg-white dark:bg-neutral-950">
      ...
      <main className="py-12 sm:py-20 overflow-visible">
        ...
        {category.faqs && category.faqs.length > 0 && (
          <section className="border-t border-black/5 dark:border-white/10 bg-slate-50 dark:bg-neutral-950/50 py-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-10">
                <h2 className="text-3xl font-bold tracking-tight">Frequently Asked Questions</h2>
                <p className="mt-4 text-black/60 dark:text-white/60">Everything you need to know about our {category.name}.</p>
              </div>
              <FaqAccordion faqs={category.faqs} toolName={category.name} />
            </div>
            
            {/* JSON-LD for Category FAQ */}
            <script
