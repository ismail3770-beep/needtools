      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 max-w-2xl mx-auto lg:mx-0">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-black dark:text-white leading-[1.15]">
              We make web tools <span className="text-brand-600 dark:text-brand-400">easy.</span>
            </h1>
            
            <p className="text-base sm:text-lg text-black/60 dark:text-white/60 leading-relaxed font-medium">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 pt-4">
              ...
              <Link
                href="#features"
                className="w-full sm:w-auto group flex items-center justify-center gap-2 rounded-xl bg-white dark:bg-neutral-950 px-7 py-3 text-sm font-semibold text-black dark:text-white border border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/5 transition-all"
              >
                See how it works
              </Link>
            </div>
          ...
          <div className="relative mx-auto w-full max-w-lg lg:max-w-none">
            {/* Window Frame Mockup */}
            <div className="relative rounded-2xl bg-white dark:bg-neutral-950 border border-black/10 dark:border-white/10 shadow-2xl overflow-hidden aspect-[4/3] sm:aspect-auto sm:h-[400px]">
              {/* Window Header */}
              <div className="flex items-center gap-2 px-4 py-3 border-b border-black/5 dark:border-white/10 bg-black/5 dark:bg-white/5">
