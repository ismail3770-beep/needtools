...
console.error("Appwrite Insert Contact Error:", err);
...
console.error("Appwrite Insert Feedback Error:", err);
...
console.error("Appwrite Record Usage Error:", err);
// Fallback to memory
